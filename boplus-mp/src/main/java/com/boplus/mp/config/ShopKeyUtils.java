...
public class ShopKeyUtils {
     ...
     * 微信公众号service
     */
    public static  String getBoplusWeiXinMpSevice(){
        String boplusWeiXinMpSevice= ShopConstants.BOPLUS_WEIXIN_MP_SERVICE;
        return  boplusWeiXinMpSevice+getExtendValue();
    }
     ...
     * 微信支付service
     */
    public static  String getBoplusWeiXinPayService(){
        String boplusWeiXinPayService= ShopConstants.BOPLUS_WEIXIN_PAY_SERVICE;
        return  boplusWeiXinPayService+getExtendValue();
    }
    /**
     * 商户号
     */
     ...
     * 微信支付小程序service
     */
    public static  String getBoplusWeiXinMiniPayService(){
        String boplusWeiXinMiniPayService= ShopConstants.BOPLUS_WEIXIN_MINI_PAY_SERVICE;
        return  boplusWeiXinMiniPayService+getExtendValue();
    }
    /**
     * 微信支付app service
     */
    public static  String getBoplusWeiXinAppPayService(){
        String boplusWeiXinAppPayService= ShopConstants.BOPLUS_WEIXIN_APP_PAY_SERVICE;
        return  boplusWeiXinAppPayService+getExtendValue();
    }
    /**
     * 微信小程序id
     */
