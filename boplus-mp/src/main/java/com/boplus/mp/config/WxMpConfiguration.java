...
import com.boplus.mp.handler.KfSessionHandler;
import com.boplus.mp.handler.LocationHandler;
import com.boplus.mp.handler.LogHandler;
import com.boplus.mp.handler.MenuHandler;
import com.boplus.mp.handler.MsgHandler;
import com.boplus.mp.handler.NullHandler;
import com.boplus.mp.handler.RedisHandler;
import com.boplus.mp.handler.ScanHandler;
import com.boplus.mp.handler.StoreCheckNotifyHandler;
import com.boplus.mp.handler.SubscribeHandler;
import com.boplus.mp.handler.UnsubscribeHandler;
...
public class WxMpConfiguration {
    ...
    public static WxMpService getWxMpService() {
        ...
        WxMpService wxMpService = mpServices.get(ShopKeyUtils.getBoplusWeiXinMpSevice());
        //增加一个redis标识
        if(wxMpService == null || RedisUtil.get(ShopKeyUtils.getBoplusWeiXinMpSevice()) == null) {
            ...
            mpServices.put(ShopKeyUtils.getBoplusWeiXinMpSevice(), wxMpService);
            routers.put(ShopKeyUtils.getBoplusWeiXinMpSevice(), newRouter(wxMpService));

            //增加标识
            RedisUtil.set(ShopKeyUtils.getBoplusWeiXinMpSevice(),"boplus");
        }
        return wxMpService;
    }
    ...
    public static void removeWxMpService(){
        RedisUtil.del(ShopKeyUtils.getBoplusWeiXinMpSevice());
        mpServices.remove(ShopKeyUtils.getBoplusWeiXinMpSevice());
        routers.remove(ShopKeyUtils.getBoplusWeiXinMpSevice());
    }
    ...
    public static WxMpMessageRouter getWxMpMessageRouter() {
        WxMpMessageRouter wxMpMessageRouter = routers.get(ShopKeyUtils.getBoplusWeiXinMpSevice());
