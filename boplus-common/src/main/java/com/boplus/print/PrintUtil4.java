 ...
 */
package com.boplus.print;

import com.boplus.constant.ShopConstants;
import com.boplus.utils.DateUtils;
...
public class PrintUtil4 {
    ...
    public static final String USER = RedisUtil.get(ShopConstants.BOPLUS_FEI_E_USER);//*必填*：账号名
    public static final String UKEY = RedisUtil.get(ShopConstants.BOPLUS_FEI_E_UKEY);//*必填*: 飞鹅云后台注册账号后生成的UKEY 【备注：这不是填打印机的KEY】
